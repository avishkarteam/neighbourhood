            ...
            <div className="row feture-tabs" data-aos="fade-up">
              <div className="col-lg-6">
                ...
                <ul className="nav nav-pills mb-3">
                  <li>
                    <Link className="nav-link active" data-bs-toggle="pill" href="#tab1">Saepe fuga</Link>
                  </li>
                  <li>
                    <Link href="#tab2" className="nav-link" data-bs-toggle="pill" >Voluptates</Link>
                  </li>
                  <li>
                    <Link href="#tab3" className="nav-link" data-bs-toggle="pill" >Corrupti</Link>
                  </li>
                </ul>
                ...
                <div className="portfolio-wrap">
                  ...
                  <div className="portfolio-info">
                    ...
                    <div className="portfolio-links">
                      <Link to="assets/img/portfolio/portfolio-1.jpg" data-gallery="portfolioGallery" className="portfokio-lightbox" title="App 1"><i className="bi bi-plus"></i></Link>
                      <Link to="portfolio-details.html" title="More Details"><i className="bi bi-link"></i></Link>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-4 col-md-6 portfolio-item filter-web">
                <div className="portfolio-wrap">
                  ...
                  <div className="portfolio-info">
                    ...
                    <p>Web</p>
                    <div className="portfolio-links">
                      <Link to="assets/img/portfolio/portfolio-2.jpg" data-gallery="portfolioGallery" className="portfokio-lightbox" title="Web 3"><i className="bi bi-plus"></i></Link>
                      <Link to="portfolio-details.html" title="More Details"><i className="bi bi-link"></i></Link>
                    </div>
                  </div>
                </div>
              ...
              <div className="col-lg-4 col-md-6 portfolio-item filter-app">
                <div className="portfolio-wrap">
                  ...
                  <div className="portfolio-info">
                    ...
                    <p>App</p>
                    <div className="portfolio-links">
                      <Link to="assets/img/portfolio/portfolio-3.jpg" data-gallery="portfolioGallery" className="portfokio-lightbox" title="App 2"><i className="bi bi-plus"></i></Link>
                      <Link to="portfolio-details.html" title="More Details"><i className="bi bi-link"></i></Link>
                    </div>
                  </div>
                </div>
              ...
              <div className="col-lg-4 col-md-6 portfolio-item filter-card">
                <div className="portfolio-wrap">
                  ...
                  <div className="portfolio-info">
                    ...
                    <p>Card</p>
                    <div className="portfolio-links">
                      <Link to="assets/img/portfolio/portfolio-4.jpg" data-gallery="portfolioGallery" className="portfokio-lightbox" title="Card 2"><i className="bi bi-plus"></i></Link>
                      <Link to="portfolio-details.html" title="More Details"><i className="bi bi-link"></i></Link>
                    </div>
                  </div>
                </div>
              ...
              <div className="col-lg-4 col-md-6 portfolio-item filter-web">
                <div className="portfolio-wrap">
                  ...
                  <div className="portfolio-info">
                    ...
                    <p>Web</p>
                    <div className="portfolio-links">
                      <Link to="assets/img/portfolio/portfolio-5.jpg" data-gallery="portfolioGallery" className="portfokio-lightbox" title="Web 2"><i className="bi bi-plus"></i></Link>
                      <Link to="portfolio-details.html" title="More Details"><i className="bi bi-link"></i></Link>
                    </div>
                  </div>
                </div>
              ...
              <div className="col-lg-4 col-md-6 portfolio-item filter-app">
                <div className="portfolio-wrap">
                  ...
                  <div className="portfolio-info">
                    ...
                    <p>App</p>
                    <div className="portfolio-links">
                      <Link to="assets/img/portfolio/portfolio-6.jpg" data-gallery="portfolioGallery" className="portfokio-lightbox" title="App 3"><i className="bi bi-plus"></i></Link>
                      <Link to="portfolio-details.html" title="More Details"><i className="bi bi-link"></i></Link>
                    </div>
                  </div>
                </div>
              ...
              <div className="col-lg-4 col-md-6 portfolio-item filter-card">
                <div className="portfolio-wrap">
                  ...
                  <div className="portfolio-info">
                    ...
                    <p>Card</p>
                    <div className="portfolio-links">
                      <Link to="assets/img/portfolio/portfolio-7.jpg" data-gallery="portfolioGallery" className="portfokio-lightbox" title="Card 1"><i className="bi bi-plus"></i></Link>
                      <Link to="portfolio-details.html" title="More Details"><i className="bi bi-link"></i></Link>
                    </div>
                  </div>
                </div>
              ...
              <div className="col-lg-4 col-md-6 portfolio-item filter-card">
                <div className="portfolio-wrap">
                  ...
                  <div className="portfolio-info">
                    ...
                    <p>Card</p>
                    <div className="portfolio-links">
                      <Link to="assets/img/portfolio/portfolio-8.jpg" data-gallery="portfolioGallery" className="portfokio-lightbox" title="Card 3"><i className="bi bi-plus"></i></Link>
                      <Link to="portfolio-details.html" title="More Details"><i className="bi bi-link"></i></Link>
                    </div>
                  </div>
                </div>
              ...
              <div className="col-lg-4 col-md-6 portfolio-item filter-web">
                <div className="portfolio-wrap">
                  ...
                  <div className="portfolio-info">
                    ...
                    <p>Web</p>
                    <div className="portfolio-links">
                      <Link to="assets/img/portfolio/portfolio-9.jpg" data-gallery="portfolioGallery" className="portfokio-lightbox" title="Web 3"><i className="bi bi-plus"></i></Link>
                      <Link to="portfolio-details.html" title="More Details"><i className="bi bi-link"></i></Link>
                    </div>
                  </div>
                </div>
            ...
            <div className="row">
              ...
              <div className="col-lg-4">
                <div className="post-box">
                  ...
                  <Link to="blog-single.html" className="readmore stretched-link mt-auto"><span>Read More</span><i className="bi bi-arrow-right"></i></Link>
                </div>
              </div>
